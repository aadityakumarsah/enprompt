...
const INSTALL_CMD =
  'curl -L -o ~/Downloads/enprompt-1.9.12.dmg https://github.com/aadityakumarsah/enprompt/releases/download/v1.9.12/enprompt-1.9.12.dmg && open ~/Downloads/enprompt-1.9.12.dmg'
