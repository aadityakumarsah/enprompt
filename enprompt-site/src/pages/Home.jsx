...
const INSTALL_CMD =
  'curl -L -o ~/Downloads/enprompt-1.9.15.dmg https://github.com/aadityakumarsah/enprompt/releases/download/v1.9.15/enprompt-1.9.15.dmg && open ~/Downloads/enprompt-1.9.15.dmg'
